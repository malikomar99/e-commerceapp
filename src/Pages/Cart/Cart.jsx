      ...
      <Layouts>
        <div className="w-[90%] mx-auto">
          <div className="flex flex-col lg:flex-row shadow-md my-10">
            <div className="lg:w-3/4 bg-white px-5 lg:px-10 py-10">
              <div className="flex justify-between border-b pb-8">
                <h1 className="font-semibold text-lg lg:text-2xl">Shopping Cart</h1>
                <h2 className="font-semibold text-lg lg:text-2xl">{Cart.length} Items</h2>
              </div>
              ...
              <div className="flex flex-col md:flex-row items-center hover:bg-gray-100 -mx-8 px-6 py-5">
                ...
                <span className="text-center w-full md:w-1/5 font-semibold text-sm mt-4 md:mt-0">$400.00</span>
                <span className="text-center w-full md:w-1/5 font-semibold text-sm mt-4 md:mt-0">$400.00</span>
              </div>
            ...
            <div id="summary" className="lg:w-1/4 px-8 py-10 bg-gray-100 mt-10 lg:mt-0">
              <h1 className="font-semibold text-lg lg:text-2xl border-b pb-8">Order Summary</h1>
